...
namespace UnityEngine.InputSystem.XR.Haptics
{
	...
	public struct SendBufferedHapticCommand : IInputDeviceCommandInfo
	{
		...
		public unsafe static SendBufferedHapticCommand Create(byte[] rumbleBuffer)
		{
			...
			SendBufferedHapticCommand sendBufferedHapticCommand = default(SendBufferedHapticCommand);
			sendBufferedHapticCommand.baseCommand = new InputDeviceCommand(Type, 1040);
			sendBufferedHapticCommand.bufferSize = num;
			SendBufferedHapticCommand result = sendBufferedHapticCommand;
