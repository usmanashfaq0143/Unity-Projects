...
namespace UnityEngine.InputSystem.Layouts
{
	...
	public struct InputDeviceDescription : IEquatable<InputDeviceDescription>
	{
		...
		{
			DeviceDescriptionJson deviceDescriptionJson = default(DeviceDescriptionJson);
			deviceDescriptionJson.@interface = interfaceName;
			deviceDescriptionJson.type = deviceClass;
			deviceDescriptionJson.product = product;
			deviceDescriptionJson.manufacturer = manufacturer;
			deviceDescriptionJson.serial = serial;
			deviceDescriptionJson.version = version;
			deviceDescriptionJson.capabilities = capabilities;
			return JsonUtility.ToJson(deviceDescriptionJson, prettyPrint: true);
		}
		...
		public static InputDeviceDescription FromJson(string json)
		{
			...
			InputDeviceDescription result = default(InputDeviceDescription);
			result.interfaceName = deviceDescriptionJson.@interface;
			result.deviceClass = deviceDescriptionJson.type;
			result.product = deviceDescriptionJson.product;
			result.manufacturer = deviceDescriptionJson.manufacturer;
			result.serial = deviceDescriptionJson.serial;
			result.version = deviceDescriptionJson.version;
			result.capabilities = deviceDescriptionJson.capabilities;
			return result;
		}
