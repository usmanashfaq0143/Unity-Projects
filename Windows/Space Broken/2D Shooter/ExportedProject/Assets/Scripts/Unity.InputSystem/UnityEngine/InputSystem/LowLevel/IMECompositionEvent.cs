...
namespace UnityEngine.InputSystem.LowLevel
{
	...
	public struct IMECompositionEvent : IInputEventTypeInfo
	{
		...
		{
			IMECompositionEvent result = default(IMECompositionEvent);
			result.baseEvent = new InputEvent(1229800787, 152, deviceId, time);
			result.compositionString = new IMECompositionString(compositionString);
			return result;
		}
	}
}
