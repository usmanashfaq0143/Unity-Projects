...
namespace UnityEngine.InputSystem.LowLevel
{
	public struct KeyboardState : IInputStateTypeInfo
	{
		...
		[InputControl(name = "shift", displayName = "Shift", layout = "DiscreteButton", usage = "Modifier", bit = 51u, sizeInBits = 2u, synthetic = true, parameters = "minValue=1,maxValue=3")]
		...
		[InputControl(name = "alt", displayName = "Alt", layout = "DiscreteButton", usage = "Modifier", bit = 53u, sizeInBits = 2u, synthetic = true, parameters = "minValue=1,maxValue=3")]
		...
		[InputControl(name = "ctrl", displayName = "Control", layout = "DiscreteButton", usage = "Modifier", bit = 55u, sizeInBits = 2u, synthetic = true, parameters = "minValue=1,maxValue=3")]
