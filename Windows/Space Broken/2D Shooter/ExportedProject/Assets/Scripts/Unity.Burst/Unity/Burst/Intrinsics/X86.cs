	...
	public static class X86
	{
		...
		public static class Sse
		{
			...
			public unsafe static v128 shuffle_ps(v128 a, v128 b, int imm8)
			{
				...
				float* ptr = &a.Float0;
				float* ptr2 = &b.Float0;
				result.Float0 = ptr[imm8 & 3];
				result.Float1 = ptr[(imm8 >> 2) & 3];
				result.Float2 = ptr2[(imm8 >> 4) & 3];
				result.Float3 = ptr2[(imm8 >> 6) & 3];
				return result;
			}
				...
				public unsafe void SetBit(int aindex, int bindex, bool val)
				{
					fixed (ushort* ptr = Bits)
					{
						if (val)
						{
							...
							*num = (ushort)(*num | (ushort)(1 << bindex));
						}
						else
						{
							ushort* num2 = ptr + aindex;
							*num2 = (ushort)(*num2 & (ushort)(~(1 << bindex)));
						}
					}
				}
