...
{
	public sealed class MethodDefinition : MethodReference, ICustomAttributeProvider, IMemberDefinition, IMetadataTokenProvider, ISecurityDeclarationProvider, ICustomDebugInformationProvider
	{
