...
namespace Mono.Cecil.PE
{
	internal sealed class ImageWriter : BinaryStreamWriter
	{
		...
		private void GetWin32Resources()
		{
			...
			{
				win32_resources = module.Image.GetReaderAt(imageResourceSection.VirtualAddress, imageResourceSection.SizeOfRawData, (uint s, BinaryStreamReader reader) => new ByteBuffer(reader.ReadBytes((int)s)));
			}
		}
