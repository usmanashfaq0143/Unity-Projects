...
{
	public sealed class ModuleDefinition : ModuleReference, IDisposable, ICustomAttributeProvider, IMetadataTokenProvider, ICustomDebugInformationProvider
	{
		...
		public void ReadSymbols()
		{
			...
			ReadSymbols(defaultSymbolReaderProvider.GetSymbolReader(this, file_name));
		}
