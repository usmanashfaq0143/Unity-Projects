namespace Unity.VisualScripting
{
	public sealed class ModuloHandler : BinaryOperatorHandler
	{
		...
		{
			Handle((byte a, byte b) => (int)a % (int)b);
			Handle((byte a, sbyte b) => (int)a % (int)b);
			Handle((byte a, short b) => (int)a % (int)b);
			Handle((byte a, ushort b) => (int)a % (int)b);
			Handle((byte a, int b) => (int)a % b);
			Handle((byte a, uint b) => a % b);
			Handle((byte a, long b) => (long)a % b);
			...
			Handle((sbyte a, byte b) => (int)a % (int)b);
			Handle((sbyte a, sbyte b) => a % b);
			Handle((sbyte a, short b) => a % b);
			Handle((sbyte a, ushort b) => (int)a % (int)b);
			Handle((sbyte a, int b) => a % b);
			Handle((sbyte a, uint b) => (long)a % (long)b);
			...
			Handle((short a, byte b) => (int)a % (int)b);
			Handle((short a, sbyte b) => a % b);
			Handle((short a, short b) => a % b);
			Handle((short a, ushort b) => (int)a % (int)b);
			Handle((short a, int b) => a % b);
			Handle((short a, uint b) => (long)a % (long)b);
			...
			Handle((ushort a, byte b) => (int)a % (int)b);
			Handle((ushort a, sbyte b) => (int)a % (int)b);
			Handle((ushort a, short b) => (int)a % (int)b);
			Handle((ushort a, ushort b) => (int)a % (int)b);
			Handle((ushort a, int b) => (int)a % b);
			Handle((ushort a, uint b) => a % b);
			Handle((ushort a, long b) => (long)a % b);
			...
			Handle((int a, uint b) => (long)a % (long)b);
			...
			Handle((uint a, sbyte b) => (long)a % (long)b);
			Handle((uint a, short b) => (long)a % (long)b);
			Handle((uint a, ushort b) => a % b);
			Handle((uint a, int b) => (long)a % (long)b);
			Handle((uint a, uint b) => a % b);
			Handle((uint a, long b) => (long)a % b);
			...
			Handle((long a, byte b) => a % (long)b);
			Handle((long a, sbyte b) => a % b);
			Handle((long a, short b) => a % b);
			Handle((long a, ushort b) => a % (long)b);
			Handle((long a, int b) => a % b);
			Handle((long a, uint b) => a % (long)b);
